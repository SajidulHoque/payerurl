...
public class PaymentResponseController {
    ...
    public Map<String, Object> payments(HttpServletRequest request) {
        ...
        getData.put("transaction_id", request.getParameter("transaction_id") != null ? request.getParameter("transaction_id") : "");
        ...
        try {
            ...
            final SecretKeySpec secret_key = new SecretKeySpec(payerurlSecretKey.getBytes(StandardCharsets.UTF_8), "HmacSHA256");
